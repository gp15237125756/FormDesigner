...
<t:datagrid queryBuilder="true" sortName="createDate" sortOrder="desc" name="tablePropertyList" title="smart.form.config"
	...
	<t:dgToolBar title="create.form" icon="icon-add" width="800" height="600" url="cgFormHeadController.do?addorupdate" funname="addForm"></t:dgToolBar>
	<t:dgToolBar title="edit.form" icon="icon-edit" width="800" height="450" url="cgFormHeadController.do?addorupdate" funname="updateForm"></t:dgToolBar>
