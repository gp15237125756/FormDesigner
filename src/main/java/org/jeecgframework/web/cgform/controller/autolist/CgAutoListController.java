...
public class CgAutoListController extends BaseController{
	...
	public void list(String id, HttpServletRequest request,
        ...
        Set<String> ks=paras.keySet();
        	for(String k:ks){
        		System.out.println("k  :"+k+" v :"+paras.get(k));
        	}
	...
	public void datagrid(String configId,String page,String field,String rows,String sort,String order, HttpServletRequest request,
		...
		String treeId = PublicUtil.getPrimaryKeyName(field);
...
//						}
	...
	@ResponseBody
	public AjaxJson del(String configId,String id,String pkName,
		...
		cgTableService.delete(table, id,pkName);
		String message = "删除成功";
