...
public class CgformButtonEntity implements java.io.Serializable {
	...
	public String toString() {
		return "CgformButtonEntity [id=" + id + ", formId=" + formId
				+ ", buttonCode=" + buttonCode + ", buttonName=" + buttonName
				+ ", buttonStyle=" + buttonStyle + ", optType=" + optType
				+ ", exp=" + exp + ", buttonStatus=" + buttonStatus
				+ ", orderNum=" + orderNum + ", buttonIcon=" + buttonIcon + "]";
	}
