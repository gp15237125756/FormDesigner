								...
								<#list data['${sub}'] as subTableData >
									...
									<td>
										...
										<#list field['${sub}'].hiddenFieldList as subTableField >
											<input type="hidden" name="${sub}[${subTableData_index}].${subTableField.field_name}" id="${sub}[${subTableData_index}].${subTableField.field_name}" 
											<#if subTableData['${subTableField.field_name}']?exists&&subTableData['${subTableField.field_name}']?is_boolean>
										    value="${subTableData['${subTableField.field_name}']?string("1","0")}" >
											<#else>
