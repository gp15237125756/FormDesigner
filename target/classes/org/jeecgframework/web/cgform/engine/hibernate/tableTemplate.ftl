			...
			<#list entity.columns as attr>
				<#if attr.content == "主键">
					<#if entity.jformPkType?if_exists?html=='UUID'>
						<id name="${attr.fieldName}" type="java.lang.String" length="${attr.length}" unsaved-value="null">
							<generator class="uuid" />
						</id>
					<#elseif entity.jformPkType?if_exists?html=='NATIVE'>
						<#if dataType=='MYSQL'>
							<id name="${attr.fieldName}" type="java.lang.Long" length="${attr.length}" unsaved-value="null">
